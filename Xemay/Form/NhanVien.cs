...
namespace Xemay
{
    public partial class NhanVien : Form
    {
        ...
        private void grabtnHĐban_Click(object sender, EventArgs e)
        {
            this.Hide();
        ...
        private void grabtnKH_Click(object sender, EventArgs e)
        {
            this.Hide();
        ...
        private void grabtnSP_Click(object sender, EventArgs e)
        {
            this.Hide();
