...
namespace Xemay
{
    public partial class BCBanHang : Form
    {
        ...
        private void grabtnBCnhaphang_Click(object sender, EventArgs e)
        {
            this.Hide();
        ...
        private void grabtnkhachhang_Click(object sender, EventArgs e)
        {
            this.Hide();
        ...
        private void grabtnsanpham_Click(object sender, EventArgs e)
        {
            this.Hide();
        ...
        private void grabtnNCC_Click(object sender, EventArgs e)
        {
            this.Hide();
        ...
        private void grabtnHĐnhap_Click(object sender, EventArgs e)
        {
            this.Hide();
        ...
        private void graHĐban_Click(object sender, EventArgs e)
        {
            this.Hide();
        ...
        private void grabtnBCbanhang_Click(object sender, EventArgs e)
        {
            this.Hide();
        ...
        private void grabtnBCdoanhthu_Click(object sender, EventArgs e)
        {
            this.Hide();
